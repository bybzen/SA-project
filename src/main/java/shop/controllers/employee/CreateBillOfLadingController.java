...
//
//        if (this.name_qtyText.getText().isEmpty() || datePicker.getEditor().getText().isEmpty() ||
...
//            alert.showAndWait();
//
//        }else if(!ch.validateName(this.name_qtyText.getText())){
//            alert = new Alert(Alert.AlertType.ERROR);
//            alert.setHeaderText(" ");
//            alert.setContentText("Please check your pattern of name device or quantity!");
//            alert.showAndWait();
//
//
...
//            alert.showAndWait();
//        }
//        else if (!(name_qtyText.getText().equals("")) && datePicker != null
...
//        String name_device = name_qtyText.getText();
...
//            preparedStatement.setString(3, name_qtyText.getText());
